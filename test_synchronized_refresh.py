...
next_cmd_id = last_cmd_id + 1
print(f"Session: {sid}, Next Command ID: {next_cmd_id}")
...
command_body = {
    "data": {
        ...
        "sessionID": sid,
        "commands": [{
            "commandNumber": next_cmd_id,
            "hash": 1234567890, # Хэш обычно вторичен, сервер его часто игнорирует
...
print("Sending Synchronized Refresh...")
