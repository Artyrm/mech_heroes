...
BATTLE_ANALYTICS_DIR = 'battle_analytics'
...
def generate_report(json_path):
    script_path = os.path.join(BATTLE_ANALYTICS_DIR, 'generate_html_report.py')
...
def process_battles(history, target_nicks):
    ...
    for nick in target_nicks:
        ...
        folder = os.path.join(BATTLE_ANALYTICS_DIR, nick)
